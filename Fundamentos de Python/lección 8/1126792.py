...
def print_table():
  print('-'*78)
  print('|{:>6}|{:>16}|{:>16}|{:>16} |{:>16} |'.format('Moneda','5 Minutos','10 Minutos','15 Minutos','30 Minutos'))
  print('-'*78)
  for key,coin in coins_table.items():
    print(f'|{key:>6}|{coin[0]:>16.4f}|{float(coin[1]):>16.4f}|{float(coin[2]):>16.4f} |{float(coin[3]):>16.4f} |')
  print('-'*78)
